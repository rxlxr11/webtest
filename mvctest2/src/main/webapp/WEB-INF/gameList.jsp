...
<script>
    ...
    async function queryByCondition(){
        ...
        var gameJsonStr = '${sessionScope.gameCondition}';
        var gameJson = gameJsonStr ? JSON.parse(gameJsonStr) : {};
        console.log(gameJson)

        await $.ajax({
            url: "${pageContext.request.contextPath}/queryByCondition",
            type: "post",
    ...
    async function setCondition(gameJson) {
        ...
        await $.ajax({
            url: "${pageContext.request.contextPath}/setCondition",
            type: "post",
            data: gameJson,
            dataType: "text",
            contentType: "application/json;utf-8",
            success: function () {
                if (window.location.href!="http://localhost:8080/mvctest2_war_exploded/toGameList"){
    ...
    function toQueryByCondition(){
        window.location.href="${pageContext.request.contextPath}/toQueryByCondition"
    }
</script>